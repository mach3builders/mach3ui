    ...
    <tr>
        <td align="center" style="background-color: {{ $backgroundColor }}; border-radius: 8px; padding: 32px;">
            ...
            <a href="{{ $buttonUrl }}" class="button"
                style="display: inline-block; background-color: {{ $primaryColor }}; color: #ffffff !important; font-size: 16px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px;">{{ $buttonText }}</a>
            <!--<![endif]-->
        </td>
    </tr>
</table>
