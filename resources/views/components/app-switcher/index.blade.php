...
@php
    ...
    $hintClasses = Ui::classes()
        ->add('fixed bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-1.5 rounded-lg border px-3 py-2 text-xs backdrop-blur-sm')
