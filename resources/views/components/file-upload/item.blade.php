...
>
    ...
    @if ($deletable)
        <button type="button" class="{{ $deleteClasses }}" {{ $attributes->whereStartsWith(['x-on:delete', '@delete', 'wire:click']) }}>
            <ui:icon
                name="x"
    ...
    @if ($isImage)
        <template x-teleport="body">
            <div
                ...
                x-on:keydown.escape.window="lightboxOpen && (lightboxOpen = false)"
                x-cloak
            >
                <button
                    type="button"
