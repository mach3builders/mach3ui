...
<div
    ...
    {{ $attributes->only('class')->class(['flex flex-col gap-3']) }}
    data-file-upload
>
    <div
        class="relative flex min-h-32 cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed p-6 transition-colors border-gray-140 bg-white hover:border-gray-400 hover:bg-gray-20 dark:border-gray-700 dark:bg-gray-800 dark:hover:border-gray-600 dark:hover:bg-gray-820"
    ...
    >
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400">{{ $placeholder }}</p>
                ...
                <div class="group relative">
                    ...
                    <template x-if="!item.preview">
                        <div class="flex size-24 flex-col items-center justify-center gap-1 rounded-lg border border-gray-200 bg-gray-100 p-2 dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <span class="w-full truncate text-center text-xs text-gray-500 dark:text-gray-400" x-text="item.name"></span>
                        </div>
                    </template>
    ...
    <template x-teleport="body">
        ...
        >
            ...
            <div class="flex max-h-[90vh] max-w-[90vw] flex-col items-center gap-4" x-on:click.stop>
                <img :src="lightboxSrc" :alt="lightboxName" class="max-h-[80vh] max-w-full rounded-lg object-contain shadow-2xl" />
