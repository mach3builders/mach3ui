...
@php
    ...
    $format_display = function($value, $locale, $display_format, $locale_data) {
        ...
        try {
            return \Carbon\Carbon::parse($value)->locale($locale)->isoFormat(
                str_replace(['M', 'j', 'Y'], ['MMM', 'D', 'YYYY'], $display_format)
            );
        } catch (\Exception $e) {
            return $value;
        }
...
<div
    ...
    style="anchor-scope: --daterange-trigger;"
    data-daterange
>
    <button
        type="button"
    ...
    >
        <span
            x-text="displayText"
            :class="{ 'text-gray-400 dark:text-gray-500': !startDisplay }"
        ></span>
    ...
    <div
        ...
        class="m-0 flex-col gap-3 rounded-lg border p-3 shadow-lg
               ...
               [&:popover-open]:flex"
        style="position-anchor: --daterange-trigger; top: calc(anchor(bottom) + 0.25rem); left: anchor(left);"
    >
        <div class="flex gap-4">
            <div class="w-64">
                <div class="mb-3 flex items-center justify-between gap-2">
                    ...
                    @else
                        <div class="flex-1 text-center text-sm font-medium text-gray-900 dark:text-gray-100" x-text="months[leftMonth] + ' ' + leftYear"></div>
                    @endif
                    ...
                    <template x-for="(d, index) in getCalendarDays(leftYear, leftMonth)" :key="'left-' + index">
                        <button
                            ...
                            :class="{
                                ...
                                'font-semibold bg-gray-100 text-gray-900 dark:bg-gray-750 dark:text-gray-100': d.today && !d.isStart && !d.isEnd,
                                'font-semibold bg-gray-900 text-white hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-200': d.isStart || d.isEnd,
            ...
            <div class="w-64">
                <div class="mb-3 flex items-center justify-between gap-2">
                    ...
                    @else
                        <div class="flex-1 text-center text-sm font-medium text-gray-900 dark:text-gray-100" x-text="months[rightMonth] + ' ' + rightYear"></div>
                    @endif
