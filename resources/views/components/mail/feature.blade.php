...
<table role="presentation" class="feature-table" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
    <tr>
        <td class="feature-icon-cell" width="64" valign="top" style="padding-right: 16px;">
            <table role="presentation" width="48" height="48" cellspacing="0" cellpadding="0" border="0" style="background-color: #e8f1ff; border-radius: 8px;">
                <tr>
