...
@php
    ...
    $classes = Ui::classes()
        ...
        ->add('after:inset-x-0 after:bottom-0 after:h-0.5 after:scale-x-0 after:bg-blue-500 [&[data-active]]:after:scale-x-100')
        ...
        ->add('[[data-variant=boxed]_&]:after:inset-0 [[data-variant=boxed]_&]:after:h-auto [[data-variant=boxed]_&]:after:-z-10 [[data-variant=boxed]_&]:after:rounded-md')
        ->add('[[data-variant=boxed]_&]:after:scale-x-100 [[data-variant=boxed]_&]:after:transition-none [[data-variant=boxed]_&]:after:opacity-0')
        ...
        // Boxed text colors
        ->add('[[data-variant=boxed]_&]:text-gray-600 [[data-variant=boxed]_&]:hover:text-gray-900 [[data-variant=boxed]_&[data-active]]:text-gray-900')
        ->add('[[data-variant=boxed]_&]:dark:text-gray-400 [[data-variant=boxed]_&]:dark:hover:text-gray-100 [[data-variant=boxed]_&[data-active]]:dark:text-gray-100')
        // Disabled
