...
@php
    ...
    $positionStyles = [
        'bottom-start' => "position-anchor: {$anchor}; top: calc(anchor(bottom) + {$offset}); bottom: auto; left: anchor(left); right: auto; position-try-fallbacks: --selectbox-top-start;",
        'bottom-end' => "position-anchor: {$anchor}; top: calc(anchor(bottom) + {$offset}); bottom: auto; right: anchor(right); left: auto; position-try-fallbacks: --selectbox-top-end;",
        'top-start' => "position-anchor: {$anchor}; bottom: calc(anchor(top) + {$offset}); top: auto; left: anchor(left); right: auto; position-try-fallbacks: --selectbox-bottom-start;",
