...
@php
    ...
    $variant_classes = [
        ...
        'outline-subtle' => [
            'border-gray-200/50 bg-gray-100/20 text-gray-600 shadow-xs',
            'hover:border-gray-300/50 hover:bg-gray-100/30 hover:text-gray-700 enabled:hover:border-gray-300/50 enabled:hover:bg-gray-100/30 enabled:hover:text-gray-700',
            'focus:ring-gray-400 focus:ring-offset-white',
            'dark:border-gray-600/50 dark:bg-gray-700/20 dark:text-gray-200 dark:hover:border-gray-500/50 dark:hover:bg-gray-700/40 dark:hover:text-gray-100 dark:enabled:hover:border-gray-500/50 dark:enabled:hover:bg-gray-700/40 dark:enabled:hover:text-gray-100',
            'dark:focus:ring-offset-gray-800',
        ],
        'outline-info' => [
            'border-cyan-300/50 bg-cyan-100/20 text-cyan-600 shadow-xs',
            'hover:border-cyan-400/50 hover:bg-cyan-100/30 hover:text-cyan-700 enabled:hover:border-cyan-400/50 enabled:hover:bg-cyan-100/30 enabled:hover:text-cyan-700',
        ...
        'outline-success' => [
            'border-green-300/50 bg-green-100/20 text-green-600 shadow-xs',
            'hover:border-green-400/50 hover:bg-green-100/30 hover:text-green-700 enabled:hover:border-green-400/50 enabled:hover:bg-green-100/30 enabled:hover:text-green-700',
            'focus:ring-green-600 focus:ring-offset-white',
        ...
        'outline-warning' => [
            'border-amber-300/50 bg-amber-100/20 text-amber-600 shadow-xs',
            'hover:border-amber-400/50 hover:bg-amber-100/30 hover:text-amber-700 enabled:hover:border-amber-400/50 enabled:hover:bg-amber-100/30 enabled:hover:text-amber-700',
        ...
        'outline-danger' => [
            'border-red-300/50 bg-red-100/20 text-red-600 shadow-xs',
            'hover:border-red-400/50 hover:bg-red-100/30 hover:text-red-700 enabled:hover:border-red-400/50 enabled:hover:bg-red-100/30 enabled:hover:text-red-700',
            'focus:ring-red-600 focus:ring-offset-white',
    ...
    $active_classes = [
        ...
        'outline-subtle' => [
            'border-gray-400/50 bg-gray-100/30 text-gray-700 dark:border-gray-600/50 dark:bg-gray-900/30 dark:text-gray-300',
        ...
        'outline-info' => [
            'border-cyan-400/50 bg-cyan-100/30 text-cyan-700 dark:border-cyan-700/50 dark:bg-cyan-900/30 dark:text-cyan-300',
        ...
        'outline-success' => [
            'border-green-400/50 bg-green-100/30 text-green-700 dark:border-green-700/50 dark:bg-green-900/30 dark:text-green-300',
        ...
        'outline-warning' => [
            'border-amber-400/50 bg-amber-100/30 text-amber-700 dark:border-amber-700/50 dark:bg-amber-900/30 dark:text-amber-300',
        ...
        'outline-danger' => [
            'border-red-400/50 bg-red-100/30 text-red-700 dark:border-red-700/50 dark:bg-red-900/30 dark:text-red-300',
